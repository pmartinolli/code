        ...
        for file in files:
            if file.lower().endswith(extension):
                ...
                try:
                    ...
                    output = process_pdf_with_ocr(
                        input_path, 
                        # output_path, # Add this if your function supports saving directly
                        language='lat', 
                        deskew=True,
                        rotate_pages=True,
                        optimize=1,
                    ...
                    # If your function returns a stream or object that needs to be saved:
